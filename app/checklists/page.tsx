          ...
          <li key={checklist.slug}>
            ...
            >
              ...
              <div>
                ...
                <h2 className="text-xl font-bold text-slate-900 group-hover:text-blue-700 transition-colors">{checklist.title}</h2>
                <p className="mt-3 text-sm leading-relaxed text-slate-600">{checklist.description}</p>
              </div>
            </Link>
          </li>
        ))}
