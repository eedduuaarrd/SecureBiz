    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/90 md:static md:bg-white">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
        ...
        <details className="group relative md:hidden">
          <summary className="min-h-11 min-w-11 cursor-pointer list-none rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-semibold text-slate-800 shadow-sm touch-manipulation active:bg-slate-50 [&::-webkit-details-marker]:hidden">
            Menu
          </summary>
